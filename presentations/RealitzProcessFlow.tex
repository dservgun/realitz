...
\section{Process flow}
  ...
  \node [block, below of=cleanup] (closure) {Closure Phase};
  \node [block, below of=closure] (optionexercise) {Option Exercise Phase};
  \node [block, below of=optionexercise]  (settlement) {Settlement and Funds transfer};
